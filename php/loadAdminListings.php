    ...
    if($result){                   
        while($row = mysqli_fetch_assoc($result)) {           
            ...
            echo 
                "<tr>    
                <td>                  
                <button onclick='setUpdateData(\"".$row['unitID']."\",
                \"".$row['status']."\",\"".$row['address']."\",\"".$price."\",\"".$row['listing_member']."\",\"".$row['end_date']."\",
                \"".$row['due_per_month']."\",\"".$row['property_type']."\",\"".$row['listing_side']."\",\"".$row['selling_side']."\",\"".$row['area']."\",
                \"".$row['zone']."\",\"".$row['community']."\",\"".$row['bedrooms']."\",\"".$row['full_baths']."\",\"".$row['half_baths']."\",
                \"".$row['year_built']."\",\"".$row['listing_office']."\",\"".$row['directions']."\",\"".$row['legal']."\",\"".$row['view']."\",
                \"".$row['pet_friendly']."\",\"".$row['list_price']."\",\"".$row['sold_price']."\",\"".$image."\")'
                class='btn btn-primary'  name='updateUser' data-toggle='modal' data-target='#updateuModal'>Update</button>
                <br>
                <button onclick='setRemoveData(\"".$row['unitID']."\")' 
                ...
                <td>" . number_format($row['due_per_month']) . "</td>
                ...
                <td>" . $pet_friendly . "</td>
                <td>" . "$" . number_format($row['list_price']) . "</td>
